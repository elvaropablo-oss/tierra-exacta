...
let active=false;
form.addEventListener('input',()=>{if(!active)return;render();});
const originalRender=render;
function activate(){active=true;originalRender();}
if(new URLSearchParams(location.search).get('litros'))activate();
else ensureSection();
